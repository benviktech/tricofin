...
//   const [staticData, setStaticData] = useState({});
  ...
  useEffect(() => {
    ...
    await axios.get(`https://tricofin.azurewebsites.net/api/System/GetSystemSettings`)
            ...
            <div className="container-main  ">
                <div className="left-container-side">
                  ...
                  <form >
                    ...
                    <div class="form-item">
                      <label for="name" class="col-form-label form-label">Company Name</label>
                      <div class="form-input-name">
                            {formState.companyName}
                      </div>
                    </div>
                    <div class="form-item">
                      <label for="physicaladdress" class=" col-form-label form-label">Physical Adress</label>
                      <div class="form-input">
                        ...
                        />
                        <br />
                        { errors.pAddress && <span className="error-display">{errors.pAddress}</span> }
                      </div>
                    </div>
                    <div class="form-item">
                      <label for="pobox" class=" col-form-label form-label">P.O. Box Address</label>
                      <div class="form-input">
                        <Input 
                        handleChange={handleChange} 
                        ...
                        />
                        <br />
                        { errors.boxAddress && <span className="error-display">{errors.boxAddress}</span> }
                      </div>
                    </div>
                    <div class="form-item">
                      <label for="pobox" class="col-form-label form-label">Email Address 1</label>
                      <div class="form-input">
                        <Input 
                        handleChange={handleChange} 
                    ...
                    <div class="form-item">
                      <label for="pobox" class="col-form-label form-label">Phone 1</label>
                      <div class="form-input">
                        <Input 
                        handleChange={handleChange} 
                    ...
                    <div class="form-item">
                      <label for="pobox" class="col-form-label form-label">Website</label>
                      <div class="form-input">
                        <Input 
                        handleChange={handleChange} 
